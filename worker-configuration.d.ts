/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=dist/server/wrangler.json` (hash: ded5615a26aacdeaa48f7554713648a2)
// Runtime types generated with workerd@1.20260811.1 2026-05-15 nodejs_compat
interface __BaseEnv_Env {
	PLUGIN_REGISTRY: KVNamespace;
	VISIT_METRICS: D1Database;
	PLUGIN_SCAN_QUEUE: Queue;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "VISIT_DISPLAY_MULTIPLIER">> {}
}
